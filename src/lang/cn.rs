...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "云联远程"),
        ("desk_tip", "云联远程可以通过下面的 ID 和密码访问。"),
        ("Password", "密码"),
        ("Ready", "云联远程已就绪"),
        ("Established", "云联远程已建立"),
        ("connecting_status", "正在接入 云联远程 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ("Service is running", "云联远程服务正在运行"),
        ("Service is not running", "云联远程服务未运行"),
        ("not_ready_status", "未就绪，请检查网络连接"),
        ("Control Remote Desktop", "云联远程桌面"),
        ("Transfer file", "传输文件"),
        ("Connect", "连接"),
        ...
        ("Connecting...", "云联远程正在连接..."),
        ("Connection in progress. Please wait.", "云联远程正在进行连接，请稍候。"),
        ("Please try 1 minute later", "一分钟后再试"),
        ("Login Error", "云联远程登录错误"),
        ("Successful", "云联远程成功"),
        ...
        ("Failed to connect to rendezvous server", "连接云联远程注册服务器失败"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 云联远程 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 云联远程 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 云联远程 \"屏幕录制\" 权限。"),
        ("Installing ...", "云联远程安装中..."),
        ("Install", "云联远程安装"),
        ("Installation", "安装"),
        ...
        ("setup_server_tip", "需要更快连接速度，可联系QQ:28272213自建服务器"),
        ...
        ("Paste", "粘贴"),
        ("Paste here?", "粘贴到这里？"),
        ("Are you sure to close the connection?", "是否确认关闭云联远程连接？"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 云联远程 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [云联远程 Input] 服务开启。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持 云联远程 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 云联远程 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 云联远程 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 云联远程 \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 云联远程 的 UAC 窗口点击确认。"),
        ("Request Elevation", "请求提权"),
        ("wait_accept_uac_tip", "请等待远端用户确认 UAC 对话框。"),
        ("Elevate successfully", "云联远程提权成功"),
        ("uppercase", "大写字母"),
        ("lowercase", "小写字母"),
        ("digit", "数字"),
        ...
        ("verify_rustdesk_password_tip", "验证 云联远程 密码"),
        ...
        ("Primary Color", "基本色"),
        ("HSV Color", "HSV 色"),
        ("Installation Successful!", "云联远程安装成功!"),
        ("Installation failed!", "安装失败!"),
        ("Reverse mouse wheel", "鼠标滚轮反向"),
        ("{} sessions", "{} 个会话"),
        ("scam_title", "云联远程提醒您！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 云联远程 启动服务，请勿继续操作并立刻挂断电话！"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，云联远程 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 云联远程 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 云联远程 后台服务"),
